...
public final class CadastroBinding implements ViewBinding {
  ...
  private CadastroBinding(@NonNull LinearLayout rootView, @NonNull Button btnCadastrar,
      @NonNull Button btnVoltar, @NonNull EditText etEmail, @NonNull EditText etNome,
      @NonNull EditText etSenha) {
  ...
  public static CadastroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CadastroBinding((LinearLayout) rootView, btnCadastrar, btnVoltar, etEmail, etNome,
          etSenha);
    }
